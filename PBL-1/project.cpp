/*			||  OOPS MICRO-PROJECT ||
	...
	1. Pranav Kulkarni(SYCOA288)     	pranav.kulkarni221@pccoepune.org
				
	2. Saurabh Asnare (SYCOA276)    	saurabh.asnare22@pccoepune.org
	...
	4.Utakarsha Late (SYCOA291)         utakarsha.late22@pccoepune.org
	 ...
	 Guided By :-			
			 ...
			 Lecturer at Pimpri Chinchwad college of engineering pune 
*/
/************************************************************************************
...
using namespace std;
/************************************************************************************
 gotoxy() function is declared for set the co-ordinate location for loading animation
**************************************************************************************/
...
//intialize static data members outside the class using scope resolution op
int customer::c = 0;
...
/************************************************************************************
 here class head is declared in which login and register operations are included
**************************************************************************************/
class head
{
...
/************************************************************************************
 in userInfo() function user regsitered data is retrive from database and display it
**************************************************************************************/
void head::userInfo()
{
    system("cls");
...
void head::captacha()
{
    int count, i, n, n1, userans;
    char ch, ans;
    gotoxy(30, 10); //gotoxy function calling
    cout << "\n\n\t\t\tGenerating Captacha Please Wait...";
    for (int i = 1; i <= 5; i++)
    {
        Sleep(500); //sleep function
        cout << ".";
    }
    cout << "\n\n\t\t\tAre You a Robot?[Y/N] : ";
    cin >> ch;
...
/************************************************************************************
 class admin product is decalred for admin operations i.e. CRUD Operations
**************************************************************************************/
class AdminProduct
{
...
/************************************************************************************
putdata() method retrivr data from database and display it
**************************************************************************************/
...
public:
    ...
    Admin(char aduser[], char adpass[]) //parametric constructor
    {
        ...
        if (strcmp(this->aduser, "pccoe") == 0 && strcmp(this->adpass, "admin123") == 0) //checking admin username and passowrd
        {
            count = 1;
            system("cls");
        }
...
void customer::custInfo()
{
    ...
    cout << "\n\t\t\tEnter Customer Name   : ";
    cin.getline(name, 100); //here getline function is used for scannig space value
    cout << "\n\n\t\t\tEnter CUstomer Id   : ";
    cin >> custId;
    cout << "\n\t\t\tEnter Email-Id : ";
    cin >> email;
