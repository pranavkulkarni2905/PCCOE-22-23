...
int main() {
  ...
  do {
    ...
    cout <<
      "3.Display node count" << endl;
    cout <<
      "4.Insert at beginning" << endl;
    cout <<
      "5.Insert at end" << endl;
    cout << "6.Insert at
    specific position " << endl; cout << "
    7. Delete
    from beginning " << endl; cout << "
    8. Delete
    from end " << endl; cout << "
    9. Delete from
    specific position " << endl; cout << "
    10. Length
      of linked list " << endl; cout << "
    11. Search
    Data " << endl; cout << "
    ...
    case 10:
      len = getlength();
      cout << "\n* Length of
      linked list = " << len << endl;
      if (len == 0) cout << "* The list
      is empty!" << endl;
      break;
    case 11:
      Search_Data(count);
